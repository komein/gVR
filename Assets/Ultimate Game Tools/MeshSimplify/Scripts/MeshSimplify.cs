...
public class MeshSimplify : MonoBehaviour
{
  ...
  public Simplifier GetMeshSimplifier()
  {
	...
	public void ComputeData(bool bRecurseIntoChildren) {
		ComputeData (bRecurseIntoChildren,null);
}
  ...
  public void ComputeData(bool bRecurseIntoChildren, Simplifier.ProgressDelegate progress)
  {
	...
	private static void ComputeDataRecursive(MeshSimplify root, GameObject gameObject, bool bRecurseIntoChildren) {
		ComputeDataRecursive (root, gameObject, bRecurseIntoChildren, null);
  ...
  public bool HasSimplifiedMesh()
  {
	...
	public void ComputeMesh(bool bRecurseIntoChildren)
	{
		ComputeMesh (bRecurseIntoChildren, null);
	}
  ...
  public void ComputeMesh(bool bRecurseIntoChildren, Simplifier.ProgressDelegate progress)
  {
	...
	private static void ComputeMeshRecursive(MeshSimplify root, GameObject gameObject, bool bRecurseIntoChildren) {
		ComputeMeshRecursive(root,  gameObject,  bRecurseIntoChildren, null);
	}
