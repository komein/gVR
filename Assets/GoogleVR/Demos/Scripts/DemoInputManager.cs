    ...
    private void UpdateStatusMessage()
    {
        ...
        switch (GvrController.State)
        {
            ...
            case GvrConnectionState.Disconnected:
                controllerMessage = DataObjects.Localization.GetField("c_disconnected");
                messageText.color = Color.white;
                break;
            case GvrConnectionState.Scanning:
                controllerMessage = DataObjects.Localization.GetField("c_scanning");
                messageText.color = Color.cyan;
                break;
            case GvrConnectionState.Connecting:
                controllerMessage = DataObjects.Localization.GetField("c_connecting");
            ...
            case GvrConnectionState.Error:
                controllerMessage = DataObjects.Localization.GetField("c_error") + GvrController.ErrorDetails;
